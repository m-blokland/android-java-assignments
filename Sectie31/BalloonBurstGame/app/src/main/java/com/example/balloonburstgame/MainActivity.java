...
public class MainActivity extends AppCompatActivity {
    ...
    public void increaseScoreByOne(View view) {
        ...
        if (view.getId() == balloon1.getId()) balloon1.setImageResource(R.drawable.boom);
        if (view.getId() == balloon2.getId()) balloon2.setImageResource(R.drawable.boom);
        if (view.getId() == balloon3.getId()) balloon3.setImageResource(R.drawable.boom);
        if (view.getId() == balloon4.getId()) balloon4.setImageResource(R.drawable.boom);
        if (view.getId() == balloon5.getId()) balloon5.setImageResource(R.drawable.boom);
        if (view.getId() == balloon6.getId()) balloon6.setImageResource(R.drawable.boom);
        if (view.getId() == balloon7.getId()) balloon7.setImageResource(R.drawable.boom);
        if (view.getId() == balloon8.getId()) balloon8.setImageResource(R.drawable.boom);
        if (view.getId() == balloon9.getId()) balloon9.setImageResource(R.drawable.boom);
    }
    ...
    public void balloonsControl() {
        ...
        runnable = () -> {
            ...
            if (score <= 5) handler.postDelayed(runnable, 2000);
            else if (score <= 10) handler.postDelayed(runnable, 1500);
            else if (score <= 15) handler.postDelayed(runnable, 1000);
            else handler.postDelayed(runnable, 500);
        };
