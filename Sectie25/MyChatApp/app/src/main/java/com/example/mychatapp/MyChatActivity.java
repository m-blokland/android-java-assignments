    ...
    public void sendMessage(String message)
    {
        ...
        reference.child("Users").child(fUser.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String notiName = Objects.requireNonNull(snapshot.child("userName")
                        .getValue()).toString();
                if (notify) sendNotification(otherName,notiName,msg);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Data data = new Data(fUser.getUid(),
                        String.valueOf(R.drawable.ic_baseline_notifications_active_24),
