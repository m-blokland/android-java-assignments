...
public class ProfileActivity extends AppCompatActivity {
    ...
    private ImageView imageViewCircleProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewCircleProfile.setOnClickListener(v -> imageChooser());
    ...
    {
        String userName = Objects.requireNonNull(editTextUserNameProfile.getText()).toString();
