...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        constraintLayout.setOnTouchListener((v, event) -> {
            ...
            if (!beginControl) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) touchControl = true;
                if (event.getAction() == MotionEvent.ACTION_UP) touchControl = false;
            }
            return true;
        });
    }
    ...
    public void moveToBird() {
        if (touchControl) birdY = birdY - (screenHeight / 50);
        else birdY = birdY + (screenHeight / 50);

        if (birdY <= 0) birdY = 0;
        if (birdY >= (screenHeight - bird.getHeight())) birdY = (screenHeight - bird.getHeight());
    ...
    public void enemyControl() {
        ...
        if (score >= 50 && score < 100) enemy1X = enemy1X - (screenWidth / 130);
        if (score >= 100 && score < 150) enemy1X = enemy1X - (screenWidth / 120);
        if (score >= 150) enemy1X = enemy1X - (screenWidth / 100);
        ...
        if (score >= 50 && score < 100) enemy2X = enemy2X - (screenWidth / 120);
        if (score >= 100 && score < 150) enemy2X = enemy2X - (screenWidth / 110);
        if (score >= 150) enemy2X = enemy2X - (screenWidth / 90);
        ...
        if (score >= 50 && score < 100) enemy3X = enemy3X - (screenWidth / 120);
        if (score >= 100 && score < 150) enemy3X = enemy3X - (screenWidth / 100);
        if (score >= 150) enemy3X = enemy3X - (screenWidth / 80);
    ...
    public void collisionControl() {
        ...
        if (right > 0 && score < 200) {
            ...
            if (right == 1) right2.setImageResource(R.drawable.favorite_grey);
            ...
            runnable2 = () -> {
                ...
                if (birdX <= screenWidth) handler2.postDelayed(runnable2, 20);
                else {
